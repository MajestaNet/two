...
[B10](backlog/B10-workflow-controller.md). Longer loops use a persisted
work graph produced at Plan, not a new required manifest field
([ADR 0014](adrs/0014-persisted-work-graph.md),
[work-graph.md](work-graph.md)).
